...
export postconf_myhostname 

: ${postconf_mydestination:="\
    localhost,\
...
export postconf_smtpd_banner

: ${postconf_smtpd_helo_required:='yes'}
export postconf_smtpd_helo_required

: ${postconf_smtpd_tls_auth_only:='yes'}
export postconf_smtpd_tls_auth_only

: ${postconf_disable_vrfy_command:='yes'}
export postconf_disable_vrfy_command

: ${postconf_strict_rfc821_envelopes:='yes'}
export postconf_strict_rfc821_envelopes

: ${postconf_postscreen_greet_action:='enforce'}
export postconf_postscreen_greet_action

: ${postconf_postscreen_dnsbl_action:='enforce'}
export postconf_postscreen_dnsbl_action

: ${postconf_postscreen_dnsbl_sites:="\
    zen.spamhaus.org,\
    psbl.surriel.com,\
    dnsbl.sorbs.net"}
export postconf_postscreen_dnsbl_sites
